...
pub fn build(b: *std.Build) void {
    ...
    exe.addIncludePath(
        b.path("../path/to/iceoryx2/target/ff/cc/install/include/iceoryx2/v0.7.1/iox2/") // replace with your own relative path, this is where iceoryx2.h lives
    );
...
const iox2 = @cImport({
    @cInclude(iox2_root ++ "/include/iceoryx2/v0.7.1/iox2/iceoryx2.h");
